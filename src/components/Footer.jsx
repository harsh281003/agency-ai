...
const Footer = ({ theme }) => {
  return (
    ...
    >
      {/*footer top */}
      <div className="flex justify-center lg:items-center max-lg:flex-col gap-10">
        <motion.div
        ...
        >
          ...
          <p className="max-w-md">
            From strategy to execution, we craft digital solutions that move you
            business forward
          </p>
        ...
        >
          ...
          <p className="text-sm mt-2 mb-6">
            The latest news,articles and resources, sent to you inbox weekly
          </p>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="pb-6 text-sm text-gray-500 flex justify-between"
      >
